package com.amitesh.portfolio.agenttelemetryelements.api;
...
public class PortfolioController {
    ...
    @GetMapping("/about")
    public Map<String, String> about() { return Map.of("product", "Agent Telemetry Elements", "recordType", "Assistant run"); }
